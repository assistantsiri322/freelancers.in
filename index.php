...
<title> freelancers.in | Home</title>
    ...
    <div class="hero" style=" color:whitesmoke; height: 1700px;">
      ...
      <!--	images in home page-->
            <div class="floating-area">
                <img class="floating" src="img/search.jpeg" width="42%" style="padding-top:90px; padding-left: 50px; padding-bottom:100px; float: left;"/>
            </div>
             ...
             <!-- Texts in home page with heading and sub texts-->
                  <div class="animated slideInRight">
                   ...
                   <br> Find the job meant for you. <b style="color: #e9c46a">#FREELANCERS</b>
                         ...
                         <button type="button" class="btn" style="width:120px; height:40px;  background-color:#e9c46a; border-radius: 0 !important;"> 
                             <a href = "mailto: urvi.jmu9@gmail.com   
                             contact : 7006000011" style="color:black;">  welcome </a>
                         </button>
                         </div>
                        ...
                        <button type="submit" style="height:45px; width:160px; border-radius:0px 30px 30px 0px; background-color: #257059; "><i class="fa fa-search bb"></i></button>
                            ...
                            if(isset($_GET['category']))
                             ...
                             ?>
                                ...
                                <?php }}else{
                                        ...
                                        echo ' <img src="img/err.jpeg" width=600px /> ';
                                        echo '</div>';
                                        } ?>
                            ...
                            <div style=" height: 100vh; " class="col-md-3">
                                ...
                                <div class="animated slideInRight dm"> 
                                    <img class="floating" src="img/think.jpeg" style="width:300px; height: 300px;"/>
                                </div>
